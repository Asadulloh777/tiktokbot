...
"""
    ...
    def user_qoshish(self, ism: str, tg_id: int, username: str):

        sql = """
        INSERT INTO users( ism, tg_id, username) VALUES(?,?,?)
        """
        self.execute(sql, parameters=(ism, tg_id, username), commit=True)
